...
(function() {
  ...
  var Github = function(options) {
    ...
    Github.Repository = function(options) {
      ...
      this.updateTreeContent = function(baseTree, path, content, cb) {
        var data = {
          "base_tree": baseTree,
          "tree": [
            {
      ...
      this.mergePullRequest = function(number, options, cb) {
          _request("PUT", repoPath + "/pulls/" + number + "/merge", options, cb);
      };
